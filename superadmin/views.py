...
def superadmin_dashboard(request):
    ...
    non_registered_influencers = InfluencerRegistration.objects.filter(
        isRegistered=False
    )
...
def manage_brand_managers(request, pk=None):
    ...
    return render(
        request,
        "registration/superadmin_dashboard.html",
        {"brand_managers": brand_managers, "form": form},
    )
...
def manage_brand_managers(request, pk=None):
    ...
    return render(
        request,
        "registration/manage_brand_managers.html",
        {"brand_managers": brand_managers, "form": form},
    )
